...
void EmptyLinkFunctionForGeneratedCodeV_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_V()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_V_OnHealthChangedSignature__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_V_OnActorKilled__DelegateSignature,
			};
