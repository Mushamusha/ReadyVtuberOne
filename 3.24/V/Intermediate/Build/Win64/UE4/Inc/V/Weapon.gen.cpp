...
static struct FScriptStruct_V_StaticRegisterNativesFHitScanTrace
{
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DefaultBullet_MetaData[];
#endif
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_DefaultBullet;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWeapon_Statics::NewProp_DefaultBullet_MetaData[] = {
		{ "Category", "weapon" },
		{ "ModuleRelativePath", "Public/Weapon.h" },
	};
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_AWeapon_Statics::NewProp_DefaultBullet = { UE4CodeGen_Private::EPropertyClass::Int, "DefaultBullet", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000010005, 1, nullptr, STRUCT_OFFSET(AWeapon, DefaultBullet), METADATA_PARAMS(Z_Construct_UClass_AWeapon_Statics::NewProp_DefaultBullet_MetaData, ARRAY_COUNT(Z_Construct_UClass_AWeapon_Statics::NewProp_DefaultBullet_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AWeapon_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AWeapon_Statics::NewProp_DefaultBullet,
	...
	IMPLEMENT_CLASS(AWeapon, 4260137755);
